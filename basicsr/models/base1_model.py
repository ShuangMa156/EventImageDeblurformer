...
from basicsr.models import lr_scheduler1 as lr_scheduler
...
class BaseModel():
    ...
    def evalmodel(self, dataloader, tb_logger, save_img=False, rgb2bgr=True, use_image=True):
        """Validation function.
        ...
        Args:
            ...
            use_image (bool): Whether to use saved images to compute metrics (PSNR, SSIM), if not, then use data directly from network' output. Default: True
        """
        return self.nondist_test(dataloader, tb_logger,
                                    save_img, rgb2bgr, use_image)
